...
def load_data():
    ...
    order_df = pd.read_csv(r'C:\Users\ASUS\Desktop\A-FAST-ECOMMERCE-RAG-CHATBOT-FOR-CUSTOMERS\Order_Data_Dataset.csv')
    product_df = pd.read_csv(r'C:\Users\ASUS\Desktop\A-FAST-ECOMMERCE-RAG-CHATBOT-FOR-CUSTOMERS\Product_Information_Dataset.csv')
